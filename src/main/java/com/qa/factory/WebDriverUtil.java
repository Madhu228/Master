...
public class WebDriverUtil {
	...
	/*
	 * public void takeScreenshots(WebElement src,WebElement desti, WebDriver
	 * driver) { Random r=new Random(); TakesScreenshot ts =
	 * (TakesScreenshot)driver; File src = ts.getScreenshotAs(OutputType.FILE);
	 * 
	 * File dest = new File("./Screenshots/"+screenshot+".png"); Files.copy(src,
	 * desti); }
	 */
	/**
